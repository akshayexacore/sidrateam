...
import '../dashboard_screen/home_screen/homescreen_widget/search_bar.dart';
          ...
          child: Column(
            children: [
              ...
              ListView.separated(
                ...
                shrinkWrap: true,
                itemCount: 5,
                itemBuilder: (context, index) => ManageDataCard(
                      ...
                      Positioned(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: SvgPicture.string(ProductSvg().deleteIcon),
                            ),
                          ))
                    ],
                  ),
