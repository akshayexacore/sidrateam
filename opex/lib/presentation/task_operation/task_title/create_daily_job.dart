...
class CreateNewDailyJob extends StatefulWidget {
  ...
  @override
  State<CreateNewDailyJob> createState() => _CreateNewDailyJobState();
}

class _CreateNewDailyJobState extends State<CreateNewDailyJob> {
  bool isTime = false;
      ...
      child: MultiBlocListener(
        ...
        child: Scaffold(
            ...
            appBar: PreferredSize(
                ...
                child: BackAppBar(
                  label: readTask?.taskName ?? "Create Daily Job",
                  isAction: false,
                  isBack: false,
                  onTap: () {
