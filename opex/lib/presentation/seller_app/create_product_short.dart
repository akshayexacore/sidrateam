...
import 'create_product_short_two.dart';

class CreateNewProductShort extends StatefulWidget {
  const CreateNewProductShort({Key? key}) : super(key: key);

  @override
  State<CreateNewProductShort> createState() => _CreateNewProductShortState();
}

class _CreateNewProductShortState extends State<CreateNewProductShort> {
  String selDivision = "";
  String selCategory = "";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: BackAppBar(
          label: "Add New Product", isAction: false,
