...
class ItemSubmitShortScreen extends StatefulWidget {
  const ItemSubmitShortScreen({super.key});

  @override
  State<ItemSubmitShortScreen> createState() => _ItemSubmitShortScreenState();
}

class _ItemSubmitShortScreenState extends State<ItemSubmitShortScreen> {
  @override
