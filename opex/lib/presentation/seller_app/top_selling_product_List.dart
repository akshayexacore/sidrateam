...
class TopSellingProductList extends StatefulWidget {
  const TopSellingProductList({super.key});

  @override
  State<TopSellingProductList> createState() => _TopSellingProductListState();
}

class _TopSellingProductListState extends State<TopSellingProductList> {
  int selected = 0;
  int isItemSelect = 0;
      ...
      body: BlocListener<SellerBloc, SellerState>(
        listener: (context, state) {
          ...
          if (state is SellersListSuccess) {
            ...
            context.read<SellerBloc>().add(TopSellingListEvent("", "", "",sellerList?[0].code));
                                                  ...
                                                  GestureDetector(
                                                    onTap: () {
                                                      setState(() {
                                                        ...
                                                        context.read<SellerBloc>().add(TopSellingListEvent("", "", "",sellerList?[index].code));
