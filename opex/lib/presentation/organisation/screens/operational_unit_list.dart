...
class OperationalUnitList extends StatefulWidget {
  OperationalUnitList({Key? key}) : super(key: key);

  @override
  State<OperationalUnitList> createState() => _OperationalUnitListState();
}

class _OperationalUnitListState extends State<OperationalUnitList> {
  int selected = 0;
  ...
  @override
  void initState() {
    context.read<OrganisationBloc>().add(const GetOperationalListEvent());
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: BackAppBar(label: "Business Units"),
      ),
