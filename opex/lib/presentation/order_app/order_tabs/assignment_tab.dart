...
class AssignmentTab extends StatefulWidget {
  ...
  AssignmentTab({Key? key, this.isPicking = false, this.isPacking = false})
      : super(key: key);
...
class _AssignmentTabState extends State<AssignmentTab> {
  ...
  @override
  void initState() {
    context.read<OrderListBloc>().add(const GetPickListEvent(isAssign: true));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<OrderStatusBloc, OrderStatusState>(
      listener: (context, state) {
        if (state is GetEmployeeListSuccess) {
          print("eyyyyyyyy heee${state.ordersList.length}");
        }
      },
                          ...
                          return Container(
                            child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  return NewOrderCard(
                                    orderId: state.ordersList[index].orderId
                                        .toString(),
