...
class PackingTab extends StatefulWidget {
  ...
  PackingTab({Key? key, this.isPicking = false, this.isPacking = false})
      : super(key: key);
...
class _PackingTabState extends State<PackingTab> {
  ...
  @override
  void initState() {
    context.read<OrderListBloc>().add(const GetPackListEvent());
    super.initState();
  }
                ...
                children: [
                  ...
                  BlocBuilder<OrderListBloc, OrderListState>(
                    builder: (context, state) {
                      if (state is GetPackListSuccess) {
                        return Container(
