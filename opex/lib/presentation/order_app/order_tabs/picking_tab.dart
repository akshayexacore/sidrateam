...
import 'package:cluster/common_widgets/custom_radio_button.dart';
...
import 'package:cluster/presentation/order_app/new_ordercard.dart';
import 'package:cluster/presentation/order_app/no_of_item_model.dart';
...
class PickingTab extends StatefulWidget {
  bool isPicking, isPacking;

// <<<<<<< HEAD:lib/presentation/order_app/tab_page.dart
// class TabPage extends StatefulWidget {
//   bool isPicking, isPacking;
//
//   TabPage({Key? key, this.isPicking = false, this.isPacking = false})
// =======
  PickingTab({Key? key, this.isPicking = false, this.isPacking = false})
// >>>>>>> 1afc9b8e9e49f8700c9eb654148555ffbd9bf097:lib/presentation/order_app/order_tabs/picking_tab.dart
      : super(key: key);

  @override
  State<PickingTab> createState() => _PickingTabState();
}

class _PickingTabState extends State<PickingTab> {
  bool isSelect = false;
  ...
  @override
  void initState() {
    context.read<OrderListBloc>().add(const GetPickListEvent());
    super.initState();
  }
                ...
                children: [
                  ...
                  BlocBuilder<OrderListBloc, OrderListState>(
                    builder: (context, state) {
                      if (state is GetPickListSuccess) {
                      ...
                      return Container(
                        child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return NewOrderCard(
                                orderId: state.ordersList[index].orderId.toString(),
                                created: state.ordersList[index].createdAt,
                                ...
                                onTap: (){
                                   PersistentNavBarNavigator.pushNewScreen(
                                      ...
                                      screen: OrderView(
                                        ...
                                        orderLineData: state.ordersList[index].lineItems,customerName: "${state.ordersList[index].orderMeta?.customerData?.fname} ${state.ordersList[index].orderMeta?.customerData?.lname}",contactNumber: state.ordersList[index].orderMeta?.customerData?.mobile),
                      ...
                      if (state is GetPickListFailed) {
                        return Container(child: Text("No data"),);
                      }
                       return customStackedLoader(context, 0.1, Colors.white.withOpacity(0.1),padding: 140);
                    },
