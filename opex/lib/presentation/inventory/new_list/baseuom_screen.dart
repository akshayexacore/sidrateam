...
class InventoryBaseUomScreen extends StatefulWidget {
  const InventoryBaseUomScreen({Key? key}) : super(key: key);

  @override
  State<InventoryBaseUomScreen> createState() => _BaseUomScreenState();
}

class _BaseUomScreenState extends State<InventoryBaseUomScreen> {
  int ?select;
  void onSelect(index){
