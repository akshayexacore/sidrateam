...
class _SegmentListScreenState extends State<SegmentListScreen> {
  ...
  void initState() {
    context
        .read<InventoryBloc>()
        .add(const GetDivisionConfigurationListEvent('', '', ''));
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<InventoryBloc, InventoryState>(
      listener: (context, state) {
        ...
        } else if (state is DeleteDivisionConfigurationSuccess) {
          showSnackBar(context,
              message: "Division Configuration Deleted Successfully",
            ...
            child: SingleChildScrollView(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    SearchCard(
                      hint: "Search A Segment...!",
                      onchange: (jj) {
                        context.read<InventoryBloc>().add(
                            GetDivisionConfigurationListEvent(
                                jj ?? "", '', ''));
                        setState(() {});
                      },
                    ),
                    ...
                    BlocBuilder<InventoryBloc, InventoryState>(
                      builder: (context, state) {
                        if (state is GetDivisionConfigurationListLoading) {
                          return Container(
                              height: 200,
                              width: w,
                        ...
                        if (state is GetDivisionConfigurationListSuccess) {
                          // group.clear();
                                    ...
                                    children: [
                                      ListView.separated(
                                        ...
                                        itemBuilder: (context, index) =>
                                          ...
                                          onTapAll: () {
                                            context.read<InventoryBloc>().add(
                                                DivisionConfigurationReadEvent(
                                                    division[index].id ?? 0));
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                "Are You Sure To Delete The Segment..?",
                                                              ...
                                                              GradientButton(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    context
                                                                        .read<
                                                                            InventoryBloc>()
                                                                        .add(DeleteDivisionConfigurationEvent(division[index].id ??
                                                                            0));
                                                                    Navigator.pop(
                                                                        context);
                                                                  },
                        ...
                        if (state is GetDivisionConfigurationListFailed) {
                          // group.clear();
                          division.clear();
                          // setState(() {});
