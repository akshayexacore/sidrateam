...
class BuyOneGetFormTwo extends StatefulWidget {
  BuyOneGetFormTwo({Key? key}) : super(key: key);

  @override
  State<BuyOneGetFormTwo> createState() => _NewPromotion2State();
}

class _NewPromotion2State extends State<BuyOneGetFormTwo> {
  String? selGender;
  bool isActive = false;
  bool isSelect = false;
