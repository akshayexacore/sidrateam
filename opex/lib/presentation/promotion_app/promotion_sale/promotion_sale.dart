...
class PromotionSaleFormTwo extends StatefulWidget {
  PromotionSaleFormTwo({Key? key}) : super(key: key);

  @override
  State<PromotionSaleFormTwo> createState() => _PromotionSaleFormState();
}

class _PromotionSaleFormState extends State<PromotionSaleFormTwo> {
  String? selGender;
  bool isActive = false;
  bool isSelect = false;
