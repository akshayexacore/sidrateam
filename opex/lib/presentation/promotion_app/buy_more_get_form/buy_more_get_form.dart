...
import 'buy_more_get_form_two.dart';

class BuyMoreGetForm extends StatefulWidget {
  final bool editDiscount;
  final String? restorationId;
  BuyMoreGetForm({Key? key,this.restorationId, required this.editDiscount}) : super(key: key);

  @override
  State<BuyMoreGetForm> createState() => _NewPromotionState();
}

class _NewPromotionState extends State<BuyMoreGetForm>  {
    ...
    return MultiBlocListener(
        ...
        BlocListener<BuyMoreBloc, BuyMoreState>(
          listener: (context, state) {
            if (state is GetBuyMoreReadLoading) {
              ...
              readDiscount = state.buyMoreList;
              ...
              offerPeriodName=readDiscount?.offerPerodName??"";
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: BackAppBar(label: "New Buy More",
              isBack: true,
              isAction: false,
              onTap: () {
                Navigator.pop(context);
